...
|------------------|--------|
| **indicators.md** | Criteria for “does this Jira ticket need frontend work?” Referenced by the shared `determine-repos` skill and by `start-jira-work` when run standalone. |
