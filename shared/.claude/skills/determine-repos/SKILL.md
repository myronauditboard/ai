...
# Determine Repos — Repo Relevance
...
**Usage**:
- Called by `check-jira.sh` for each ticket after branch name is generated and before launching backend/frontend agents
