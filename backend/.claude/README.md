...
|------------------|--------|
| **indicators.md** | Criteria for “does this Jira ticket need backend work?” Referenced by the shared `check-jira` skill and by `start-jira-work` when run standalone. |
